...
export default function AssetExample() {
  return (
      <TouchableOpacity style={styles.tocando} onPress={()=>poses.navigation.navigate("Home1")}>
          <Image style={styles.capaMusicaTocando} source={require('../assets/capa.jpg')} /> 
          ...
          <View style={styles.textosTocando}>
           ...
           <View style={styles.iconesBotoes}> 
              <Image style={styles.botoesIcone} source={require('../assets/Select.png')} /> 
              <Image style={styles.botoesIcone} source={require('../assets/Heart.png')} /> 
              <Image style={styles.botoesIcone} source={require('../assets/Play.png')} /> 
           </View>
          </TouchableOpacity>
  );
}
